...
describe('GameBoard', () => {
  test('renders empty board correctly', () => {
    ...
    const gameBoard = screen
      .getByLabelText('Drop piece in column 1')
      .closest('.game-board');
  ...
  test('does not call onColumnClick when disabled', () => {
    ...
    render(<GameBoard board={board} onColumnClick={onColumnClick} disabled />);
  ...
  test('applies custom className', () => {
    ...
    const { container } = render(
      <GameBoard board={board} className="custom-board" />
    );
